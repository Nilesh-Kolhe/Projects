...
const Login = () => {
    ...
    const getAccessToken = async (clientId, code) => {
        ...
        // params.append("redirect_uri", "http://localhost:3000/login"); // For Login
        params.append("redirect_uri", "http://nilesh-kolhe.github.io/Projects/#/login");
    ...
    const redirectToAuthCodeFlow = async (clientId) => {
        ...
        // params.append("redirect_uri", "http://localhost:3000/login"); // For Local
        params.append("redirect_uri", "http://nilesh-kolhe.github.io/Projects/#/login");
